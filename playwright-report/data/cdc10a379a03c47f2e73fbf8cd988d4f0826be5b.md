...
- Name: realtime.spec.ts >> dashboard receives realtime event from dev event endpoint
- Location: tests\e2e\realtime.spec.ts:5:5
...
Locator: getByText('Realtime Events')
Expected: visible
Error: strict mode violation: getByText('Realtime Events') resolved to 3 elements:
    1) <div>Realtime Events</div> aka getByText('Realtime Events', { exact: true })
    2) <div>Realtime events are rendered through a virtualize…</div> aka getByText('Realtime events are rendered')
    3) <div>No realtime events yet.</div> aka getByText('No realtime events yet.')

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('Realtime Events')
              ...
              - generic [ref=e189]:
                ...
                - generic [ref=e193]:
                  - generic [ref=e194]:
                    ...
                    - generic [ref=e200]: "request_id: req_1778428079248_jft2zyws"
                  - generic [ref=e201]:
                    - generic [ref=e202]:
                    ...
                    - generic [ref=e207]: "request_id: req_1778428079248_zgenrvue"
                  - generic [ref=e208]:
                    - generic [ref=e209]:
                    ...
                    - generic [ref=e214]: "request_id: req_1778428079248_3urduom6"
                  - generic [ref=e215]:
                    - generic [ref=e216]:
                    ...
                    - generic [ref=e221]: "request_id: req_1778428079248_jft2zyws"
                  - generic [ref=e222]:
                    - generic [ref=e223]:
                    ...
                    - generic [ref=e228]: "request_id: req_1778428079248_zgenrvue"
                  - generic [ref=e229]:
                    - generic [ref=e230]:
                    ...
                    - generic [ref=e235]: "request_id: req_1778428073769_xqlkgrtg"
                  - generic [ref=e236]:
                    - generic [ref=e237]:
                    ...
                    - generic [ref=e242]: "request_id: req_1778428073769_xqlkgrtg"
                  - generic [ref=e243]:
                    - generic [ref=e244]:
                    ...
                    - generic [ref=e249]: "request_id: req_1778428072125_fy40g4qu"
```
...
```ts
  ...
  3  | import { e2eEnv } from "./fixtures/e2e-env";
  4  | 
  5  | test("dashboard receives realtime event from dev event endpoint", async ({
  6  |   page,
  7  |   request,
  8  | }) => {
  9  |   await loginAsAdmin(page);
  10 | 
> 11 |   await expect(page.getByText("Realtime Events")).toBeVisible();
     |                                                   ^ Error: expect(locator).toBeVisible() failed
  12 | 
  13 |   await request.post(`${e2eEnv.controlPlaneBaseUrl}/_dev/events/test`);
  14 | 
  15 |   await expect(page.getByText("route.updated").first()).toBeVisible({
  16 |     timeout: 10_000,
  17 |   });
  18 | });
```